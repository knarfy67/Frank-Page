    ...
    <div className="md:pt-28 pt-30 mx-12 md:mx-0 z-10 flex flex-col items-center justify-center">
      <div className="flex gap-2">
        <motion.p
          ...
          className="dark:text-light text-base border-b-2 dark:border-b-white font-light md:text-4xl text-2xl italic"
        >
          Frank
        </motion.p>
        <motion.p
          ...
          className="dark:text-light  text-third font-bold md:text-4xl text-2xl"
        >
          Here!
        </motion.p>
      </div>
      <div className="flex gap-2">
        <motion.p
          ...
          className="lg:text-8xl md:text-6xl sm:text-4xl text-3xl text-secondary font-bold whitespace-nowrap"
        >
          Full stack
        </motion.p>
        <motion.p
          ...
          className="lg:text-8xl md:text-6xl sm:text-4xl text-3xl dark:text-light text-third font-bold"
        >
          Developer
        </motion.p>
      </div>
      <motion.p
        ...
        className="dark:text-light md:text-6xl sm:text-4xl text-3xl text-third"
      >
        &
      </motion.p>
      ...
      <motion.p
        ...
        className="text-center mt-2 dark:text-light lg:mx-52 mx-20 md:font-md hidden md:block"
      >
      ...
      <motion.div
        ...
        className="md:flex mt-6 justify-center items-center"
      >
